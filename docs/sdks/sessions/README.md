...
<!-- UsageSnippet language="csharp" operationID="create-session" method="post" path="/sessions" example="create-session-201-1" -->
```csharp
using Mollie;
...
<!-- UsageSnippet language="csharp" operationID="get-session" method="get" path="/sessions/{sessionId}" example="get-session-200-1" -->
```csharp
using Mollie;
using Mollie.Models.Components;
