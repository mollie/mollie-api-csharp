...
<!-- UsageSnippet language="csharp" operationID="get-onboarding-status" method="get" path="/v2/onboarding/me" example="get-onboarding-status-200-1" -->
```csharp
using Mollie;
...
<!-- UsageSnippet language="csharp" operationID="submit-onboarding-data" method="post" path="/v2/onboarding/me" -->
```csharp
using Mollie;
using Mollie.Models.Components;
