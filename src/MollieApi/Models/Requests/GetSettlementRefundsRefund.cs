...
namespace MollieApi.Models.Requests
{
    ...
    public class GetSettlementRefundsRefund
    {
        ...
        /// </summary>
        [JsonProperty("amount")]
        public GetSettlementRefundsAmount? Amount { get; set; }
        ...
        public GetSettlementRefundsSettlementAmount? SettlementAmount { get; set; } = null;

        /// <summary>
        /// Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
        /// </summary>
        [JsonProperty("metadata")]
        public GetSettlementRefundsMetadataUnion? Metadata { get; set; } = null;
        ...
        public GetSettlementRefundsExternalReference? ExternalReference { get; set; }
        ...
        public List<GetSettlementRefundsRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public GetSettlementRefundsRefundLinks? Links { get; set; }
    }
}