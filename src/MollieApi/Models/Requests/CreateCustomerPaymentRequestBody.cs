...
namespace MollieApi.Models.Requests
{
    ...
    public class CreateCustomerPaymentRequestBody
    {
        ...
        /// </summary>
        [JsonProperty("amount")]
        public CreateCustomerPaymentAmountRequest Amount { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("lines")]
        public List<CreateCustomerPaymentLineRequest>? Lines { get; set; } = null;
        ...
        public CreateCustomerPaymentBillingAddressRequest? BillingAddress { get; set; }
        ...
        public CreateCustomerPaymentShippingAddressRequest? ShippingAddress { get; set; }
        ...
        /// <summary>
        /// Normally, a payment method screen is shown. However, when using this parameter, you can choose a specific payment method and your customer will skip the selection screen and is sent directly to the chosen payment method. The parameter enables you to fully integrate the payment method selection into your website.<br/>
        /// 
        /// <remarks>
        /// <br/>
        /// You can also specify the methods in an array. By doing so we will still show the payment method selection screen but will only show the methods specified in the array. For example, you can use this functionality to only show payment methods from a specific country to your customer `[&apos;bancontact&apos;, &apos;belfius&apos;]`.<br/>
        /// <br/>
        ...
        /// <remarks>
        /// <br/>
        /// **⚠️ With the introduction of iDEAL 2 in 2025, this field will be ignored for iDEAL payments. For more information on the migration, refer to our <a href="https://help.mollie.com/hc/articles/19100313768338-iDEAL-2-0">help center</a>.**<br/>
        /// <br/>
        /// Some payment methods are a network of connected banks or card issuers. In these cases, after selecting the payment method, the customer may still need to select the appropriate issuer before the payment can proceed.<br/>
        /// <br/>
        /// We provide hosted issuer selection screens, but these screens can be skipped by providing the `issuer` via the API up front.<br/>
        /// <br/>
        /// The full list of issuers for a specific method can be retrieved via the Methods API by using the optional `issuers` include.<br/>
        /// <br/>
        ...
        public CreateCustomerPaymentMetadataRequestUnion? Metadata { get; set; } = null;
        ...
        public CreateCustomerPaymentApplicationFeeRequest? ApplicationFee { get; set; } = null;
        ...
        public List<CreateCustomerPaymentRoutingRequest>? Routing { get; set; } = null;
