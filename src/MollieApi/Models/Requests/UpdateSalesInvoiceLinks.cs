...
namespace MollieApi.Models.Requests
{
    ...
    public class UpdateSalesInvoiceLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public UpdateSalesInvoiceSelf? Self { get; set; }
        ...
        public UpdateSalesInvoiceInvoicePayment? InvoicePayment { get; set; }

        /// <summary>
        /// The URL the invoice is available at, if generated.
        /// </summary>
        [JsonProperty("pdfLink")]
        public UpdateSalesInvoicePdfLink? PdfLink { get; set; } = null;

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public UpdateSalesInvoiceDocumentation? Documentation { get; set; }
    }
}