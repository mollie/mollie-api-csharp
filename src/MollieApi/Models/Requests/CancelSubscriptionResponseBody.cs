...
namespace MollieApi.Models.Requests
{
    ...
    /// <summary>
    /// The updated subscription object with status `canceled`. For a complete reference of the subscription object, refer to the <a href="get-subscription">Get subscription endpoint</a> documentation.
    /// </summary>
    public class CancelSubscriptionResponseBody
    {
        ...
        /// </summary>
        [JsonProperty("amount")]
        public CancelSubscriptionAmount? Amount { get; set; }
        ...
        public CancelSubscriptionApplicationFee? ApplicationFee { get; set; }
        ...
        public CancelSubscriptionMetadataUnion? Metadata { get; set; } = null;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public CancelSubscriptionLinks? Links { get; set; }
    }
}