...
namespace MollieApi.Models.Requests
{
    ...
    public class CreateSalesInvoiceLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public CreateSalesInvoiceSelf? Self { get; set; }
        ...
        public CreateSalesInvoiceInvoicePayment? InvoicePayment { get; set; }

        /// <summary>
        /// The URL the invoice is available at, if generated.
        /// </summary>
        [JsonProperty("pdfLink")]
        public CreateSalesInvoicePdfLink? PdfLink { get; set; } = null;

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public CreateSalesInvoiceDocumentation? Documentation { get; set; }
    }
}