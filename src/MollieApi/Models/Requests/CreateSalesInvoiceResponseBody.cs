...
namespace MollieApi.Models.Requests
{
    ...
    public class CreateSalesInvoiceResponseBody
    {
        ...
        public CreateSalesInvoiceMetadataResponse? Metadata { get; set; } = null;
        ...
        public CreateSalesInvoicePaymentDetailsResponse? PaymentDetails { get; set; } = null;
        ...
        public CreateSalesInvoiceEmailDetailsResponse? EmailDetails { get; set; } = null;
        ...
        public CreateSalesInvoiceRecipientResponse? Recipient { get; set; } = null;
        ...
        /// </summary>
        [JsonProperty("lines")]
        public List<CreateSalesInvoiceLineResponse>? Lines { get; set; } = null;

        /// <summary>
        /// The discount to be applied to the entire invoice, applied on top of any line item discounts.
        /// </summary>
        [JsonProperty("discount")]
        public CreateSalesInvoiceDiscountResponse? Discount { get; set; } = null;

        /// <summary>
        /// The amount that is left to be paid.
        /// </summary>
        [JsonProperty("amountDue")]
        public CreateSalesInvoiceAmountDue? AmountDue { get; set; }

        /// <summary>
        /// The total amount without VAT before discounts.
        /// </summary>
        [JsonProperty("subtotalAmount")]
        public CreateSalesInvoiceSubtotalAmount? SubtotalAmount { get; set; }

        /// <summary>
        /// The total amount with VAT.
        /// </summary>
        [JsonProperty("totalAmount")]
        public CreateSalesInvoiceTotalAmount? TotalAmount { get; set; }

        /// <summary>
        /// The total VAT amount.
        /// </summary>
        [JsonProperty("totalVatAmount")]
        public CreateSalesInvoiceTotalVatAmount? TotalVatAmount { get; set; }

        /// <summary>
        /// The total amount without VAT after discounts.
        /// </summary>
        [JsonProperty("discountedSubtotalAmount")]
        public CreateSalesInvoiceDiscountedSubtotalAmount? DiscountedSubtotalAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("_links")]
        public CreateSalesInvoiceLinks? Links { get; set; }
    }
}