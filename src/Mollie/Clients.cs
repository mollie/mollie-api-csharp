...
namespace Mollie
{
    ...
    public class Clients: IClients
    {
        ...
        public async Task<ListClientsResponse> ListAsync(string? embed = null, string? fromP = null, long? limit = null, string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-clients", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<GetClientResponse> GetAsync(string id, string? embed = null, string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-client", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
