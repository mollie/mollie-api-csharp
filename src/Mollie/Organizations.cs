...
namespace Mollie
{
    ...
    public class Organizations: IOrganizations
    {
        ...
        public async Task<GetOrganizationResponse> GetAsync(string id, bool? testmode = null, string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-organization", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<GetCurrentOrganizationResponse> GetCurrentAsync(string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-current-organization", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<GetPartnerStatusResponse> GetPartnerAsync(string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-partner-status", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
