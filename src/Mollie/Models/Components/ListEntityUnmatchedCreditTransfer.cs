...
namespace Mollie.Models.Components
{
    ...
    public class ListEntityUnmatchedCreditTransfer
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("source")]
        public ListEntityUnmatchedCreditTransferSource Source { get; set; } = default!;

        /// <summary>
        /// Remittance information provided with the unmatched credit transfer.
        /// </summary>
        [JsonProperty("remittanceInformation")]
        public ListEntityUnmatchedCreditTransferRemittanceInformation RemittanceInformation { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListEntityUnmatchedCreditTransferLinks Links { get; set; } = default!;
    }
}