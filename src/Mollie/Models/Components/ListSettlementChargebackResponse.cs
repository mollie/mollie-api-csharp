...
namespace Mollie.Models.Components
{
    ...
    public class ListSettlementChargebackResponse
    {
        ...
        /// </summary>
        [JsonProperty("reason")]
        public ListSettlementChargebackResponseReason? Reason { get; set; } = null;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListSettlementChargebackResponseLinks Links { get; set; } = default!;
