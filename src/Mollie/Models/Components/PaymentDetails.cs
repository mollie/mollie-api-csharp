...
namespace Mollie.Models.Components
{
    ...
    public class PaymentDetails
    {
        ...
        /// <br/>
        /// For banking-based payment methods — such as iDEAL — this is normally either an IBAN or a domestic bank<br/>
        /// account number.<br/>
        /// <br/>
        ...
        /// <summary>
        /// For wallet payment methods — such as Apple Pay and PayPal — the shipping address is often already known by<br/>
        ...
        public PaymentDetailsCardAuditionResponse? CardAudience { get; set; } = null;
        ...
        /// <summary>
        /// Date the payment has been signed by the customer, in `YYYY-MM-DD` format. Only available if the payment has<br/>
        /// been signed.
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("qrCode")]
        public PaymentDetailsQrCode? QrCode { get; set; }
