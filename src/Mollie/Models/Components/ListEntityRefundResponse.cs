...
namespace Mollie.Models.Components
{
    ...
    public class ListEntityRefundResponse
    {
        ...
        public ListEntityRefundResponseSettlementAmount? SettlementAmount { get; set; } = null;
        ...
        [JsonProperty("status")]
        public ListEntityRefundResponseStatus Status { get; set; } = default!;
        ...
        public ListEntityRefundResponseExternalReference? ExternalReference { get; set; }
        ...
        public List<ListEntityRefundResponseRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public ListEntityRefundResponseLinks Links { get; set; } = default!;
    }
}