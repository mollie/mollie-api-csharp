...
namespace Mollie.Models.Components
{
    ...
    /// </summary>
    public enum SubTotalsTransactionType
    {
    ...
    public static class SubTotalsTransactionTypeExtension
    {
        public static string Value(this SubTotalsTransactionType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static SubTotalsTransactionType ToEnum(this string value)
        {
            foreach(var field in typeof(SubTotalsTransactionType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is SubTotalsTransactionType)
                    {
                        return (SubTotalsTransactionType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum SubTotalsTransactionType");
        }
    }
