...
namespace Mollie.Models.Components
{
    ...
    public class ListEntitySettlement
    {
        ...
        public Dictionary<string, Dictionary<string, ListEntitySettlementPeriods>>? Periods { get; set; }

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public ListEntitySettlementLinks Links { get; set; } = default!;
    }
}