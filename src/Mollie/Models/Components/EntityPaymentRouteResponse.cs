...
namespace Mollie.Models.Components
{
    ...
    public class EntityPaymentRouteResponse
    {
        ...
        public EntityPaymentRouteResponseDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public EntityPaymentRouteResponseLinks Links { get; set; } = default!;
    }
}