...
namespace Mollie.Models.Components
{
    ...
    /// </summary>
    public class ListSettlementPaymentResponseDetails
    {
        /// <summary>
        ...
        public ListSettlementPaymentResponseReceipt? Receipt { get; set; }
        ...
        /// </summary>
        [JsonProperty("qrCode")]
        public ListSettlementPaymentResponseQrCode? QrCode { get; set; }
