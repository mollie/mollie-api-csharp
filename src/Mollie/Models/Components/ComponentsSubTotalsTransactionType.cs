...
namespace Mollie.Models.Components
{
    ...
    /// </summary>
    public enum ComponentsSubTotalsTransactionType
    {
    ...
    public static class ComponentsSubTotalsTransactionTypeExtension
    {
        public static string Value(this ComponentsSubTotalsTransactionType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ComponentsSubTotalsTransactionType ToEnum(this string value)
        {
            foreach(var field in typeof(ComponentsSubTotalsTransactionType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ComponentsSubTotalsTransactionType)
                    {
                        return (ComponentsSubTotalsTransactionType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ComponentsSubTotalsTransactionType");
        }
    }
