...
namespace Mollie.Models.Components
{
    ...
    public class RefundResponse
    {
        ...
        [JsonProperty("status")]
        public RefundResponseStatus Status { get; set; } = default!;
        ...
        public RefundResponseExternalReference? ExternalReference { get; set; }
        ...
        public List<RefundResponseRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public RefundResponseLinks Links { get; set; } = default!;
    }
}