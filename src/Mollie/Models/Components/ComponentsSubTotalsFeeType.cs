...
namespace Mollie.Models.Components
{
    ...
    /// </summary>
    public enum ComponentsSubTotalsFeeType
    {
    ...
    public static class ComponentsSubTotalsFeeTypeExtension
    {
        public static string Value(this ComponentsSubTotalsFeeType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ComponentsSubTotalsFeeType ToEnum(this string value)
        {
            foreach(var field in typeof(ComponentsSubTotalsFeeType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ComponentsSubTotalsFeeType)
                    {
                        return (ComponentsSubTotalsFeeType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ComponentsSubTotalsFeeType");
        }
    }
