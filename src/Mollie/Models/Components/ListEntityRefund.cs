...
namespace Mollie.Models.Components
{
    ...
    public class ListEntityRefund
    {
        ...
        public ListEntityRefundSettlementAmount? SettlementAmount { get; set; } = null;
        ...
        [JsonProperty("status")]
        public ListEntityRefundStatus Status { get; set; } = default!;
        ...
        public ListEntityRefundExternalReference? ExternalReference { get; set; }
        ...
        public List<ListEntityRefundRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public ListEntityRefundLinks Links { get; set; } = default!;
    }
}