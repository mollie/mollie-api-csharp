...
namespace Mollie.Models.Components
{
    ...
    public class ListMandateResponse
    {
        ...
        public ListMandateResponseDetails Details { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("scopes")]
        public List<ListMandateResponseScope>? Scopes { get; set; } = null;

        [JsonProperty("status")]
        public ListMandateResponseStatus Status { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListMandateResponseLinks Links { get; set; } = default!;
    }
}