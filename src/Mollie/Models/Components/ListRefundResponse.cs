...
namespace Mollie.Models.Components
{
    ...
    public class ListRefundResponse
    {
        ...
        [JsonProperty("status")]
        public ListRefundResponseStatus Status { get; set; } = default!;
        ...
        public ListRefundResponseExternalReference? ExternalReference { get; set; }
        ...
        public List<ListRefundResponseRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public ListRefundResponseLinks Links { get; set; } = default!;
    }
}