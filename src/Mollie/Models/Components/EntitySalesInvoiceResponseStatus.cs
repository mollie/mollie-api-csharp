...
namespace Mollie.Models.Components
{
    ...
    /// </remarks>
    /// </summary>
    public enum EntitySalesInvoiceResponseStatus
    {
        [JsonProperty("draft")]
        Draft,
        [JsonProperty("issued")]
    ...
    public static class EntitySalesInvoiceResponseStatusExtension
    {
        public static string Value(this EntitySalesInvoiceResponseStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static EntitySalesInvoiceResponseStatus ToEnum(this string value)
        {
            foreach(var field in typeof(EntitySalesInvoiceResponseStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is EntitySalesInvoiceResponseStatus)
                    {
                        return (EntitySalesInvoiceResponseStatus)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum EntitySalesInvoiceResponseStatus");
        }
    }
