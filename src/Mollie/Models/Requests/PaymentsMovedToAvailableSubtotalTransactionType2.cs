...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PaymentsMovedToAvailableSubtotalTransactionType2
    {
    ...
    public static class PaymentsMovedToAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this PaymentsMovedToAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PaymentsMovedToAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(PaymentsMovedToAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PaymentsMovedToAvailableSubtotalTransactionType2)
                    {
                        return (PaymentsMovedToAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PaymentsMovedToAvailableSubtotalTransactionType2");
        }
    }
