...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum GetPaymentLinkPaymentsCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class GetPaymentLinkPaymentsCaptureDelayExtension
    {
        public static string Value(this GetPaymentLinkPaymentsCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GetPaymentLinkPaymentsCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(GetPaymentLinkPaymentsCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is GetPaymentLinkPaymentsCaptureDelay)
                    {
                        return (GetPaymentLinkPaymentsCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum GetPaymentLinkPaymentsCaptureDelay");
        }
    }
