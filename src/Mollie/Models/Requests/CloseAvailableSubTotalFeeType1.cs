...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CloseAvailableSubTotalFeeType1
    {
    ...
    public static class CloseAvailableSubTotalFeeType1Extension
    {
        public static string Value(this CloseAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CloseAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CloseAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CloseAvailableSubTotalFeeType1)
                    {
                        return (CloseAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CloseAvailableSubTotalFeeType1");
        }
    }
