...
namespace Mollie.Models.Requests
{
    ...
    public class UpdateWebhookResponseBody
    {
        ...
        public List<UpdateWebhookEventTypeWebhookEventTypes> EventTypes { get; set; } = default!;

        /// <summary>
        /// The subscription&apos;s current status.
        /// </summary>
        [JsonProperty("status")]
        public UpdateWebhookStatus Status { get; set; } = default!;

        /// <summary>
        /// Whether this entity was created in live mode or in test mode.
        /// </summary>
        [JsonProperty("mode")]
        public UpdateWebhookMode Mode { get; set; } = default!;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public UpdateWebhookLinks Links { get; set; } = default!;
    }
}