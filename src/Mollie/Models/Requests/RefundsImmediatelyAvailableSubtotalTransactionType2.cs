...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsImmediatelyAvailableSubtotalTransactionType2
    {
    ...
    public static class RefundsImmediatelyAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this RefundsImmediatelyAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsImmediatelyAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsImmediatelyAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsImmediatelyAvailableSubtotalTransactionType2)
                    {
                        return (RefundsImmediatelyAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsImmediatelyAvailableSubtotalTransactionType2");
        }
    }
