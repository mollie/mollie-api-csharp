...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreatePaymentCaptureDelayResponse
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class CreatePaymentCaptureDelayResponseExtension
    {
        public static string Value(this CreatePaymentCaptureDelayResponse value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreatePaymentCaptureDelayResponse ToEnum(this string value)
        {
            foreach(var field in typeof(CreatePaymentCaptureDelayResponse).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreatePaymentCaptureDelayResponse)
                    {
                        return (CreatePaymentCaptureDelayResponse)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreatePaymentCaptureDelayResponse");
        }
    }
