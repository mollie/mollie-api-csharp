...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class FeePrepaymentsImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this FeePrepaymentsImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (FeePrepaymentsImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsImmediatelyAvailableSubTotalFeeType1");
        }
    }
