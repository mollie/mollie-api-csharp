...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsPendingSubtotalTransactionType2
    {
    ...
    public static class CorrectionsPendingSubtotalTransactionType2Extension
    {
        public static string Value(this CorrectionsPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsPendingSubtotalTransactionType2)
                    {
                        return (CorrectionsPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsPendingSubtotalTransactionType2");
        }
    }
