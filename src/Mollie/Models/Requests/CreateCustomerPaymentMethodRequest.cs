...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreateCustomerPaymentMethodRequest
    {
        [JsonProperty("alma")]
        Alma,
    ...
    public static class CreateCustomerPaymentMethodRequestExtension
    {
        public static string Value(this CreateCustomerPaymentMethodRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreateCustomerPaymentMethodRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreateCustomerPaymentMethodRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreateCustomerPaymentMethodRequest)
                    {
                        return (CreateCustomerPaymentMethodRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreateCustomerPaymentMethodRequest");
        }
    }
