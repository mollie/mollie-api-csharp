...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CapitalMovedToAvailableSubTotalFeeType1
    {
    ...
    public static class CapitalMovedToAvailableSubTotalFeeType1Extension
    {
        public static string Value(this CapitalMovedToAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CapitalMovedToAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CapitalMovedToAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CapitalMovedToAvailableSubTotalFeeType1)
                    {
                        return (CapitalMovedToAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CapitalMovedToAvailableSubTotalFeeType1");
        }
    }
