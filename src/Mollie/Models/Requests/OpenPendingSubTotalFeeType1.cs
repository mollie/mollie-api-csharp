...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum OpenPendingSubTotalFeeType1
    {
    ...
    public static class OpenPendingSubTotalFeeType1Extension
    {
        public static string Value(this OpenPendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static OpenPendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(OpenPendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is OpenPendingSubTotalFeeType1)
                    {
                        return (OpenPendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum OpenPendingSubTotalFeeType1");
        }
    }
