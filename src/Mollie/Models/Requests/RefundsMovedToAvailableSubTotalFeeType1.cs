...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsMovedToAvailableSubTotalFeeType1
    {
    ...
    public static class RefundsMovedToAvailableSubTotalFeeType1Extension
    {
        public static string Value(this RefundsMovedToAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsMovedToAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsMovedToAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsMovedToAvailableSubTotalFeeType1)
                    {
                        return (RefundsMovedToAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsMovedToAvailableSubTotalFeeType1");
        }
    }
