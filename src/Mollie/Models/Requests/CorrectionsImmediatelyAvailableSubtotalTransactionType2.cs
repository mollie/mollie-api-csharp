...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsImmediatelyAvailableSubtotalTransactionType2
    {
    ...
    public static class CorrectionsImmediatelyAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this CorrectionsImmediatelyAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsImmediatelyAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsImmediatelyAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsImmediatelyAvailableSubtotalTransactionType2)
                    {
                        return (CorrectionsImmediatelyAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsImmediatelyAvailableSubtotalTransactionType2");
        }
    }
