...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalancePendingSubTotalTransactionType1
    {
    ...
    public static class PendingBalancePendingSubTotalTransactionType1Extension
    {
        public static string Value(this PendingBalancePendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalancePendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalancePendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalancePendingSubTotalTransactionType1)
                    {
                        return (PendingBalancePendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalancePendingSubTotalTransactionType1");
        }
    }
