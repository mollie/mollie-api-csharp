...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalanceMovedToAvailableSubtotalTransactionType2
    {
    ...
    public static class PendingBalanceMovedToAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this PendingBalanceMovedToAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalanceMovedToAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalanceMovedToAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalanceMovedToAvailableSubtotalTransactionType2)
                    {
                        return (PendingBalanceMovedToAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalanceMovedToAvailableSubtotalTransactionType2");
        }
    }
