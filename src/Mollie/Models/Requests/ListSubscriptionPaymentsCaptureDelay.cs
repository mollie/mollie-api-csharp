...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListSubscriptionPaymentsCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class ListSubscriptionPaymentsCaptureDelayExtension
    {
        public static string Value(this ListSubscriptionPaymentsCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListSubscriptionPaymentsCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(ListSubscriptionPaymentsCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListSubscriptionPaymentsCaptureDelay)
                    {
                        return (ListSubscriptionPaymentsCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListSubscriptionPaymentsCaptureDelay");
        }
    }
