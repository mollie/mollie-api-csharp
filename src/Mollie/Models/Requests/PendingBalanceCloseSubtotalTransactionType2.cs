...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalanceCloseSubtotalTransactionType2
    {
    ...
    public static class PendingBalanceCloseSubtotalTransactionType2Extension
    {
        public static string Value(this PendingBalanceCloseSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalanceCloseSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalanceCloseSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalanceCloseSubtotalTransactionType2)
                    {
                        return (PendingBalanceCloseSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalanceCloseSubtotalTransactionType2");
        }
    }
