...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public class ListCustomerPaymentsPaymentLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public ListCustomerPaymentsPaymentSelf Self { get; set; } = default!;

        /// <summary>
        /// The URL your customer should visit to make the payment. This is where you should redirect the customer to.
        /// </summary>
        [JsonProperty("checkout")]
        public ListCustomerPaymentsCheckout? Checkout { get; set; }

        /// <summary>
        /// The deeplink URL to the app of the payment method. Currently only available for `bancontact`.
        /// </summary>
        [JsonProperty("mobileAppCheckout")]
        public ListCustomerPaymentsMobileAppCheckout? MobileAppCheckout { get; set; }
        ...
        public ListCustomerPaymentsChangePaymentState? ChangePaymentState { get; set; }

        /// <summary>
        /// Direct link to the payment in the Mollie Dashboard.
        /// </summary>
        [JsonProperty("dashboard")]
        public ListCustomerPaymentsDashboard Dashboard { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="list-payment-refunds">refunds</a> that belong to this payment.
        /// </summary>
        [JsonProperty("refunds")]
        public ListCustomerPaymentsRefunds? Refunds { get; set; }
        ...
        public ListCustomerPaymentsChargebacks? Chargebacks { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="list-payment-captures">captures</a> that belong to this payment.
        /// </summary>
        [JsonProperty("captures")]
        public ListCustomerPaymentsCaptures? Captures { get; set; }
        ...
        public ListCustomerPaymentsSettlement? Settlement { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-customer">customer</a>.
        /// </summary>
        [JsonProperty("customer")]
        public ListCustomerPaymentsCustomer? Customer { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-mandate">mandate</a>.
        /// </summary>
        [JsonProperty("mandate")]
        public ListCustomerPaymentsMandate? Mandate { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-subscription">subscription</a>.
        /// </summary>
        [JsonProperty("subscription")]
        public ListCustomerPaymentsSubscription? Subscription { get; set; }
        ...
        /// </summary>
        [JsonProperty("order")]
        public ListCustomerPaymentsOrder? Order { get; set; }
        ...
        public ListCustomerPaymentsTerminal? Terminal { get; set; }

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public ListCustomerPaymentsPaymentDocumentation? Documentation { get; set; }
        ...
        /// </summary>
        [JsonProperty("status")]
        public ListCustomerPaymentsLinksStatus? Status { get; set; }
        ...
        public ListCustomerPaymentsPayOnline? PayOnline { get; set; }
    }
}