...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsPendingSubTotalFeeType1
    {
    ...
    public static class CorrectionsPendingSubTotalFeeType1Extension
    {
        public static string Value(this CorrectionsPendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsPendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsPendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsPendingSubTotalFeeType1)
                    {
                        return (CorrectionsPendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsPendingSubTotalFeeType1");
        }
    }
