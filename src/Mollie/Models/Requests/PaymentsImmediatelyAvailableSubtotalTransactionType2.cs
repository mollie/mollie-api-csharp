...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PaymentsImmediatelyAvailableSubtotalTransactionType2
    {
    ...
    public static class PaymentsImmediatelyAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this PaymentsImmediatelyAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PaymentsImmediatelyAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(PaymentsImmediatelyAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PaymentsImmediatelyAvailableSubtotalTransactionType2)
                    {
                        return (PaymentsImmediatelyAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PaymentsImmediatelyAvailableSubtotalTransactionType2");
        }
    }
