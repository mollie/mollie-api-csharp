...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TopupsPendingSubtotalFeeType2
    {
    ...
    public static class TopupsPendingSubtotalFeeType2Extension
    {
        public static string Value(this TopupsPendingSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TopupsPendingSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(TopupsPendingSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TopupsPendingSubtotalFeeType2)
                    {
                        return (TopupsPendingSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TopupsPendingSubtotalFeeType2");
        }
    }
