...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TransfersImmediatelyAvailableSubtotalTransactionType2
    {
    ...
    public static class TransfersImmediatelyAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this TransfersImmediatelyAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TransfersImmediatelyAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(TransfersImmediatelyAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransfersImmediatelyAvailableSubtotalTransactionType2)
                    {
                        return (TransfersImmediatelyAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TransfersImmediatelyAvailableSubtotalTransactionType2");
        }
    }
