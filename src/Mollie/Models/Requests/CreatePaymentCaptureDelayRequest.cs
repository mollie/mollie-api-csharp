...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreatePaymentCaptureDelayRequest
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class CreatePaymentCaptureDelayRequestExtension
    {
        public static string Value(this CreatePaymentCaptureDelayRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreatePaymentCaptureDelayRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreatePaymentCaptureDelayRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreatePaymentCaptureDelayRequest)
                    {
                        return (CreatePaymentCaptureDelayRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreatePaymentCaptureDelayRequest");
        }
    }
