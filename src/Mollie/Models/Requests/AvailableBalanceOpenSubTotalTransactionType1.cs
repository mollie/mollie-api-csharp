...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum AvailableBalanceOpenSubTotalTransactionType1
    {
    ...
    public static class AvailableBalanceOpenSubTotalTransactionType1Extension
    {
        public static string Value(this AvailableBalanceOpenSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AvailableBalanceOpenSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(AvailableBalanceOpenSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AvailableBalanceOpenSubTotalTransactionType1)
                    {
                        return (AvailableBalanceOpenSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AvailableBalanceOpenSubTotalTransactionType1");
        }
    }
