...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public class CreatePaymentLinksResponse
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public CreatePaymentSelfResponse Self { get; set; } = default!;

        /// <summary>
        /// The URL your customer should visit to make the payment. This is where you should redirect the customer to.
        /// </summary>
        [JsonProperty("checkout")]
        public CreatePaymentCheckout? Checkout { get; set; }

        /// <summary>
        /// The deeplink URL to the app of the payment method. Currently only available for `bancontact`.
        /// </summary>
        [JsonProperty("mobileAppCheckout")]
        public CreatePaymentMobileAppCheckout? MobileAppCheckout { get; set; }
        ...
        public CreatePaymentChangePaymentState? ChangePaymentState { get; set; }

        /// <summary>
        /// Direct link to the payment in the Mollie Dashboard.
        /// </summary>
        [JsonProperty("dashboard")]
        public CreatePaymentDashboard Dashboard { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="list-payment-refunds">refunds</a> that belong to this payment.
        /// </summary>
        [JsonProperty("refunds")]
        public CreatePaymentRefunds? Refunds { get; set; }
        ...
        /// </summary>
        [JsonProperty("order")]
        public CreatePaymentOrder? Order { get; set; }
        ...
        public CreatePaymentTerminal? Terminal { get; set; }

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public CreatePaymentDocumentation? Documentation { get; set; }
        ...
        /// </summary>
        [JsonProperty("status")]
        public CreatePaymentLinksStatus? Status { get; set; }
        ...
        public CreatePaymentPayOnline? PayOnline { get; set; }
    }
}