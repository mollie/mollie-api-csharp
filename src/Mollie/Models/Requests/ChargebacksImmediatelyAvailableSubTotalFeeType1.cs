...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ChargebacksImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class ChargebacksImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this ChargebacksImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ChargebacksImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(ChargebacksImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ChargebacksImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (ChargebacksImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ChargebacksImmediatelyAvailableSubTotalFeeType1");
        }
    }
