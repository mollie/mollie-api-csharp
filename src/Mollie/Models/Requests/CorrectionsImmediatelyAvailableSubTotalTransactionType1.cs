...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsImmediatelyAvailableSubTotalTransactionType1
    {
    ...
    public static class CorrectionsImmediatelyAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this CorrectionsImmediatelyAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsImmediatelyAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsImmediatelyAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsImmediatelyAvailableSubTotalTransactionType1)
                    {
                        return (CorrectionsImmediatelyAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsImmediatelyAvailableSubTotalTransactionType1");
        }
    }
