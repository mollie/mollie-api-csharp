...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TransfersMovedToAvailableSubtotalFeeType2
    {
    ...
    public static class TransfersMovedToAvailableSubtotalFeeType2Extension
    {
        public static string Value(this TransfersMovedToAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TransfersMovedToAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(TransfersMovedToAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransfersMovedToAvailableSubtotalFeeType2)
                    {
                        return (TransfersMovedToAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TransfersMovedToAvailableSubtotalFeeType2");
        }
    }
