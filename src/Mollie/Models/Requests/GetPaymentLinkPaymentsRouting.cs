...
namespace Mollie.Models.Requests
{
    ...
    public class GetPaymentLinkPaymentsRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public GetPaymentLinkPaymentsRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public GetPaymentLinkPaymentsRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public GetPaymentLinkPaymentsDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public GetPaymentLinkPaymentsRoutingLinks Links { get; set; } = default!;
    }
}