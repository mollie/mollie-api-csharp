...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ChargebacksMovedToAvailableSubTotalTransactionType1
    {
    ...
    public static class ChargebacksMovedToAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this ChargebacksMovedToAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ChargebacksMovedToAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(ChargebacksMovedToAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ChargebacksMovedToAvailableSubTotalTransactionType1)
                    {
                        return (ChargebacksMovedToAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ChargebacksMovedToAvailableSubTotalTransactionType1");
        }
    }
