...
namespace Mollie.Models.Requests
{
    ...
    public class ListCustomerPaymentsRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public ListCustomerPaymentsRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public ListCustomerPaymentsRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public ListCustomerPaymentsDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListCustomerPaymentsRoutingLinks Links { get; set; } = default!;
    }
}