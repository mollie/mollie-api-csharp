...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TransfersMovedToAvailableSubTotalTransactionType1
    {
    ...
    public static class TransfersMovedToAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this TransfersMovedToAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TransfersMovedToAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(TransfersMovedToAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransfersMovedToAvailableSubTotalTransactionType1)
                    {
                        return (TransfersMovedToAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TransfersMovedToAvailableSubTotalTransactionType1");
        }
    }
