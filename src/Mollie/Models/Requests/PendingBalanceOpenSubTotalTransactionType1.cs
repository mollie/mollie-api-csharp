...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalanceOpenSubTotalTransactionType1
    {
    ...
    public static class PendingBalanceOpenSubTotalTransactionType1Extension
    {
        public static string Value(this PendingBalanceOpenSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalanceOpenSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalanceOpenSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalanceOpenSubTotalTransactionType1)
                    {
                        return (PendingBalanceOpenSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalanceOpenSubTotalTransactionType1");
        }
    }
