...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public class ListAllSubscriptionsSubscriptionLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public ListAllSubscriptionsSubscriptionSelf Self { get; set; } = default!;
        ...
        public ListAllSubscriptionsMandate? Mandate { get; set; } = null;
        ...
        public ListAllSubscriptionsProfile? Profile { get; set; }
        ...
        public ListAllSubscriptionsPayments? Payments { get; set; } = null;

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public ListAllSubscriptionsSubscriptionDocumentation Documentation { get; set; } = default!;
    }
}