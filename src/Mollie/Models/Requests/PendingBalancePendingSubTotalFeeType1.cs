...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalancePendingSubTotalFeeType1
    {
    ...
    public static class PendingBalancePendingSubTotalFeeType1Extension
    {
        public static string Value(this PendingBalancePendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalancePendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalancePendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalancePendingSubTotalFeeType1)
                    {
                        return (PendingBalancePendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalancePendingSubTotalFeeType1");
        }
    }
