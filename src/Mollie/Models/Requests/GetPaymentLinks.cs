...
namespace Mollie.Models.Requests
{
    ...
    public class GetPaymentLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public GetPaymentSelf Self { get; set; } = default!;

        /// <summary>
        /// The URL your customer should visit to make the payment. This is where you should redirect the customer to.
        /// </summary>
        [JsonProperty("checkout")]
        public GetPaymentCheckout? Checkout { get; set; }

        /// <summary>
        /// The deeplink URL to the app of the payment method. Currently only available for `bancontact`.
        /// </summary>
        [JsonProperty("mobileAppCheckout")]
        public GetPaymentMobileAppCheckout? MobileAppCheckout { get; set; }
        ...
        public GetPaymentChangePaymentState? ChangePaymentState { get; set; }

        /// <summary>
        /// Direct link to the payment in the Mollie Dashboard.
        /// </summary>
        [JsonProperty("dashboard")]
        public GetPaymentDashboard Dashboard { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="list-payment-refunds">refunds</a> that belong to this payment.
        /// </summary>
        [JsonProperty("refunds")]
        public GetPaymentRefunds? Refunds { get; set; }
        ...
        /// </summary>
        [JsonProperty("order")]
        public GetPaymentOrder? Order { get; set; }
        ...
        public GetPaymentTerminal? Terminal { get; set; }

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public GetPaymentDocumentation? Documentation { get; set; }
        ...
        /// </summary>
        [JsonProperty("status")]
        public GetPaymentLinksStatus? Status { get; set; }
        ...
        public GetPaymentPayOnline? PayOnline { get; set; }
    }
}