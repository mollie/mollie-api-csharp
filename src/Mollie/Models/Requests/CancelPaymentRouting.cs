...
namespace Mollie.Models.Requests
{
    ...
    public class CancelPaymentRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public CancelPaymentRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public CancelPaymentRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public CancelPaymentDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public CancelPaymentRoutingLinks Links { get; set; } = default!;
    }
}