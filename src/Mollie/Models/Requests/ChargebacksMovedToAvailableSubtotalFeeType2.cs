...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ChargebacksMovedToAvailableSubtotalFeeType2
    {
    ...
    public static class ChargebacksMovedToAvailableSubtotalFeeType2Extension
    {
        public static string Value(this ChargebacksMovedToAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ChargebacksMovedToAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(ChargebacksMovedToAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ChargebacksMovedToAvailableSubtotalFeeType2)
                    {
                        return (ChargebacksMovedToAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ChargebacksMovedToAvailableSubtotalFeeType2");
        }
    }
