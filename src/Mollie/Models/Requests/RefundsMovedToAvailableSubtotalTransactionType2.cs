...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsMovedToAvailableSubtotalTransactionType2
    {
    ...
    public static class RefundsMovedToAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this RefundsMovedToAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsMovedToAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsMovedToAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsMovedToAvailableSubtotalTransactionType2)
                    {
                        return (RefundsMovedToAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsMovedToAvailableSubtotalTransactionType2");
        }
    }
