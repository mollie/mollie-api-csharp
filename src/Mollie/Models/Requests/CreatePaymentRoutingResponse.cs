...
namespace Mollie.Models.Requests
{
    ...
    public class CreatePaymentRoutingResponse
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public CreatePaymentRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public CreatePaymentRoutingAmountResponse Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public CreatePaymentDestinationResponse Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public CreatePaymentRoutingLinksResponse Links { get; set; } = default!;
    }
}