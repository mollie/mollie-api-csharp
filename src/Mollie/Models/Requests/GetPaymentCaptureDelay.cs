...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum GetPaymentCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class GetPaymentCaptureDelayExtension
    {
        public static string Value(this GetPaymentCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GetPaymentCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(GetPaymentCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is GetPaymentCaptureDelay)
                    {
                        return (GetPaymentCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum GetPaymentCaptureDelay");
        }
    }
