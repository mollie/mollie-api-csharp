...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreateCustomerPaymentCaptureDelayRequest
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class CreateCustomerPaymentCaptureDelayRequestExtension
    {
        public static string Value(this CreateCustomerPaymentCaptureDelayRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreateCustomerPaymentCaptureDelayRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreateCustomerPaymentCaptureDelayRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreateCustomerPaymentCaptureDelayRequest)
                    {
                        return (CreateCustomerPaymentCaptureDelayRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreateCustomerPaymentCaptureDelayRequest");
        }
    }
