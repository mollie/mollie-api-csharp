...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsPendingSubTotalTransactionType1
    {
    ...
    public static class RefundsPendingSubTotalTransactionType1Extension
    {
        public static string Value(this RefundsPendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsPendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsPendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsPendingSubTotalTransactionType1)
                    {
                        return (RefundsPendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsPendingSubTotalTransactionType1");
        }
    }
