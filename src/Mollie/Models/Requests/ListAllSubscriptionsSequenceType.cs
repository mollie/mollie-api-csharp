...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListAllSubscriptionsSequenceType
    {
        [JsonProperty("oneoff")]
        Oneoff,
        [JsonProperty("first")]
    ...
    public static class ListAllSubscriptionsSequenceTypeExtension
    {
        public static string Value(this ListAllSubscriptionsSequenceType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListAllSubscriptionsSequenceType ToEnum(this string value)
        {
            foreach(var field in typeof(ListAllSubscriptionsSequenceType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListAllSubscriptionsSequenceType)
                    {
                        return (ListAllSubscriptionsSequenceType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListAllSubscriptionsSequenceType");
        }
    }
