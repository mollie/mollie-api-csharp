...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsMovedToAvailableSubtotalFeeType2
    {
    ...
    public static class FeePrepaymentsMovedToAvailableSubtotalFeeType2Extension
    {
        public static string Value(this FeePrepaymentsMovedToAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsMovedToAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsMovedToAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsMovedToAvailableSubtotalFeeType2)
                    {
                        return (FeePrepaymentsMovedToAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsMovedToAvailableSubtotalFeeType2");
        }
    }
