...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreateCustomerPaymentCaptureDelayResponse
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class CreateCustomerPaymentCaptureDelayResponseExtension
    {
        public static string Value(this CreateCustomerPaymentCaptureDelayResponse value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreateCustomerPaymentCaptureDelayResponse ToEnum(this string value)
        {
            foreach(var field in typeof(CreateCustomerPaymentCaptureDelayResponse).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreateCustomerPaymentCaptureDelayResponse)
                    {
                        return (CreateCustomerPaymentCaptureDelayResponse)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreateCustomerPaymentCaptureDelayResponse");
        }
    }
