...
namespace Mollie.Models.Requests
{
    ...
    public class ListAllSubscriptionsRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public ListAllSubscriptionsRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public ListAllSubscriptionsRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public ListAllSubscriptionsDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListAllSubscriptionsRoutingLinks Links { get; set; } = default!;
    }
}