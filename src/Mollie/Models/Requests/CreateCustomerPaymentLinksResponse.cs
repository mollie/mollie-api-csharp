...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public class CreateCustomerPaymentLinksResponse
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public CreateCustomerPaymentSelfResponse Self { get; set; } = default!;

        /// <summary>
        /// The URL your customer should visit to make the payment. This is where you should redirect the customer to.
        /// </summary>
        [JsonProperty("checkout")]
        public CreateCustomerPaymentCheckout? Checkout { get; set; }

        /// <summary>
        /// The deeplink URL to the app of the payment method. Currently only available for `bancontact`.
        /// </summary>
        [JsonProperty("mobileAppCheckout")]
        public CreateCustomerPaymentMobileAppCheckout? MobileAppCheckout { get; set; }
        ...
        public CreateCustomerPaymentChangePaymentState? ChangePaymentState { get; set; }

        /// <summary>
        /// Direct link to the payment in the Mollie Dashboard.
        /// </summary>
        [JsonProperty("dashboard")]
        public CreateCustomerPaymentDashboard Dashboard { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="list-payment-refunds">refunds</a> that belong to this payment.
        /// </summary>
        [JsonProperty("refunds")]
        public CreateCustomerPaymentRefunds? Refunds { get; set; }
        ...
        public CreateCustomerPaymentChargebacks? Chargebacks { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="list-payment-captures">captures</a> that belong to this payment.
        /// </summary>
        [JsonProperty("captures")]
        public CreateCustomerPaymentCaptures? Captures { get; set; }
        ...
        public CreateCustomerPaymentSettlement? Settlement { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-customer">customer</a>.
        /// </summary>
        [JsonProperty("customer")]
        public CreateCustomerPaymentCustomer? Customer { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-mandate">mandate</a>.
        /// </summary>
        [JsonProperty("mandate")]
        public CreateCustomerPaymentMandate? Mandate { get; set; }

        /// <summary>
        /// The API resource URL of the <a href="get-subscription">subscription</a>.
        /// </summary>
        [JsonProperty("subscription")]
        public CreateCustomerPaymentSubscription? Subscription { get; set; }
        ...
        /// </summary>
        [JsonProperty("order")]
        public CreateCustomerPaymentOrder? Order { get; set; }
        ...
        public CreateCustomerPaymentTerminal? Terminal { get; set; }

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public CreateCustomerPaymentDocumentation? Documentation { get; set; }
        ...
        /// </summary>
        [JsonProperty("status")]
        public CreateCustomerPaymentLinksStatus? Status { get; set; }
        ...
        public CreateCustomerPaymentPayOnline? PayOnline { get; set; }
    }
}