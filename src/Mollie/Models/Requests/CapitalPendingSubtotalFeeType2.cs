...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CapitalPendingSubtotalFeeType2
    {
    ...
    public static class CapitalPendingSubtotalFeeType2Extension
    {
        public static string Value(this CapitalPendingSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CapitalPendingSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CapitalPendingSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CapitalPendingSubtotalFeeType2)
                    {
                        return (CapitalPendingSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CapitalPendingSubtotalFeeType2");
        }
    }
