...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TopupsImmediatelyAvailableSubtotalFeeType2
    {
    ...
    public static class TopupsImmediatelyAvailableSubtotalFeeType2Extension
    {
        public static string Value(this TopupsImmediatelyAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TopupsImmediatelyAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(TopupsImmediatelyAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TopupsImmediatelyAvailableSubtotalFeeType2)
                    {
                        return (TopupsImmediatelyAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TopupsImmediatelyAvailableSubtotalFeeType2");
        }
    }
