...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CloseAvailableSubtotalTransactionType2
    {
    ...
    public static class CloseAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this CloseAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CloseAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CloseAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CloseAvailableSubtotalTransactionType2)
                    {
                        return (CloseAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CloseAvailableSubtotalTransactionType2");
        }
    }
