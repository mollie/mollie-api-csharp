...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ChargebacksPendingSubtotalTransactionType2
    {
    ...
    public static class ChargebacksPendingSubtotalTransactionType2Extension
    {
        public static string Value(this ChargebacksPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ChargebacksPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(ChargebacksPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ChargebacksPendingSubtotalTransactionType2)
                    {
                        return (ChargebacksPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ChargebacksPendingSubtotalTransactionType2");
        }
    }
