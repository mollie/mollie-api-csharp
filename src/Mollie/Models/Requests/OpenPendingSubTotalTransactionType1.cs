...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum OpenPendingSubTotalTransactionType1
    {
    ...
    public static class OpenPendingSubTotalTransactionType1Extension
    {
        public static string Value(this OpenPendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static OpenPendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(OpenPendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is OpenPendingSubTotalTransactionType1)
                    {
                        return (OpenPendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum OpenPendingSubTotalTransactionType1");
        }
    }
