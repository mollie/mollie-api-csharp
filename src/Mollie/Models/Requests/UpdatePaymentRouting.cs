...
namespace Mollie.Models.Requests
{
    ...
    public class UpdatePaymentRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public UpdatePaymentRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public UpdatePaymentRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public UpdatePaymentDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public UpdatePaymentRoutingLinks Links { get; set; } = default!;
    }
}