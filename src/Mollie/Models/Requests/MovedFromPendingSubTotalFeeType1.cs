...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum MovedFromPendingSubTotalFeeType1
    {
    ...
    public static class MovedFromPendingSubTotalFeeType1Extension
    {
        public static string Value(this MovedFromPendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static MovedFromPendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(MovedFromPendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is MovedFromPendingSubTotalFeeType1)
                    {
                        return (MovedFromPendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum MovedFromPendingSubTotalFeeType1");
        }
    }
