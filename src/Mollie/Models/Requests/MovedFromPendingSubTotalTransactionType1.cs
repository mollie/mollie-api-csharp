...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum MovedFromPendingSubTotalTransactionType1
    {
    ...
    public static class MovedFromPendingSubTotalTransactionType1Extension
    {
        public static string Value(this MovedFromPendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static MovedFromPendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(MovedFromPendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is MovedFromPendingSubTotalTransactionType1)
                    {
                        return (MovedFromPendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum MovedFromPendingSubTotalTransactionType1");
        }
    }
