...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CancelPaymentCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class CancelPaymentCaptureDelayExtension
    {
        public static string Value(this CancelPaymentCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CancelPaymentCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(CancelPaymentCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CancelPaymentCaptureDelay)
                    {
                        return (CancelPaymentCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CancelPaymentCaptureDelay");
        }
    }
