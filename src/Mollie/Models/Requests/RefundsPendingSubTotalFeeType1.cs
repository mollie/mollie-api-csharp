...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsPendingSubTotalFeeType1
    {
    ...
    public static class RefundsPendingSubTotalFeeType1Extension
    {
        public static string Value(this RefundsPendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsPendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsPendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsPendingSubTotalFeeType1)
                    {
                        return (RefundsPendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsPendingSubTotalFeeType1");
        }
    }
