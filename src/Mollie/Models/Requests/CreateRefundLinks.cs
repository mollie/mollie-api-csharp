...
namespace Mollie.Models.Requests
{
    ...
    public class CreateRefundLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public CreateRefundSelf Self { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="get-payment">payment</a> that this refund belongs to.
        /// </summary>
        [JsonProperty("payment")]
        public CreateRefundPayment Payment { get; set; } = default!;
        ...
        public CreateRefundDocumentation Documentation { get; set; } = default!;
    }
}