...
namespace Mollie.Models.Requests
{
    ...
    public class GetCurrentOrganizationResponseBody
    {
        ...
        /// </summary>
        [JsonProperty("locale")]
        public GetCurrentOrganizationLocale? Locale { get; set; }

        /// <summary>
        /// The address of the organization.
        /// </summary>
        [JsonProperty("address")]
        public GetCurrentOrganizationAddress? Address { get; set; }
        ...
        public GetCurrentOrganizationVatRegulation? VatRegulation { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public GetCurrentOrganizationLinks? Links { get; set; }
    }
}