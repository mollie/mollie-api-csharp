...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsMovedToAvailableSubtotalTransactionType2
    {
    ...
    public static class FeePrepaymentsMovedToAvailableSubtotalTransactionType2Extension
    {
        public static string Value(this FeePrepaymentsMovedToAvailableSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsMovedToAvailableSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsMovedToAvailableSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsMovedToAvailableSubtotalTransactionType2)
                    {
                        return (FeePrepaymentsMovedToAvailableSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsMovedToAvailableSubtotalTransactionType2");
        }
    }
