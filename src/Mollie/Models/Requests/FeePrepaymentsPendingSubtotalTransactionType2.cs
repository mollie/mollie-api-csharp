...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsPendingSubtotalTransactionType2
    {
    ...
    public static class FeePrepaymentsPendingSubtotalTransactionType2Extension
    {
        public static string Value(this FeePrepaymentsPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsPendingSubtotalTransactionType2)
                    {
                        return (FeePrepaymentsPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsPendingSubtotalTransactionType2");
        }
    }
