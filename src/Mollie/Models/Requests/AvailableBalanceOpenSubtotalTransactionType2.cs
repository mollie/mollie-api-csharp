...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum AvailableBalanceOpenSubtotalTransactionType2
    {
    ...
    public static class AvailableBalanceOpenSubtotalTransactionType2Extension
    {
        public static string Value(this AvailableBalanceOpenSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AvailableBalanceOpenSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(AvailableBalanceOpenSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AvailableBalanceOpenSubtotalTransactionType2)
                    {
                        return (AvailableBalanceOpenSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AvailableBalanceOpenSubtotalTransactionType2");
        }
    }
