...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PaymentsImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class PaymentsImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this PaymentsImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PaymentsImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PaymentsImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PaymentsImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (PaymentsImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PaymentsImmediatelyAvailableSubTotalFeeType1");
        }
    }
