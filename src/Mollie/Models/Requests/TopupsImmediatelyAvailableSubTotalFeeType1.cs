...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TopupsImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class TopupsImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this TopupsImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TopupsImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(TopupsImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TopupsImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (TopupsImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TopupsImmediatelyAvailableSubTotalFeeType1");
        }
    }
