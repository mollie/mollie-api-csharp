...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreateCustomerPaymentLocaleRequest
    {
        [JsonProperty("en_US")]
        EnUS,
        [JsonProperty("en_GB")]
    ...
    public static class CreateCustomerPaymentLocaleRequestExtension
    {
        public static string Value(this CreateCustomerPaymentLocaleRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreateCustomerPaymentLocaleRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreateCustomerPaymentLocaleRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreateCustomerPaymentLocaleRequest)
                    {
                        return (CreateCustomerPaymentLocaleRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreateCustomerPaymentLocaleRequest");
        }
    }
