...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListAllSubscriptionsCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class ListAllSubscriptionsCaptureDelayExtension
    {
        public static string Value(this ListAllSubscriptionsCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListAllSubscriptionsCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(ListAllSubscriptionsCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListAllSubscriptionsCaptureDelay)
                    {
                        return (ListAllSubscriptionsCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListAllSubscriptionsCaptureDelay");
        }
    }
