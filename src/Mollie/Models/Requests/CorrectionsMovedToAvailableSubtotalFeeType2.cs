...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsMovedToAvailableSubtotalFeeType2
    {
    ...
    public static class CorrectionsMovedToAvailableSubtotalFeeType2Extension
    {
        public static string Value(this CorrectionsMovedToAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsMovedToAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsMovedToAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsMovedToAvailableSubtotalFeeType2)
                    {
                        return (CorrectionsMovedToAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsMovedToAvailableSubtotalFeeType2");
        }
    }
