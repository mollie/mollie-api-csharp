...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum OpenPendingSubtotalTransactionType2
    {
    ...
    public static class OpenPendingSubtotalTransactionType2Extension
    {
        public static string Value(this OpenPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static OpenPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(OpenPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is OpenPendingSubtotalTransactionType2)
                    {
                        return (OpenPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum OpenPendingSubtotalTransactionType2");
        }
    }
