...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum GetSalesInvoiceStatus
    {
        [JsonProperty("draft")]
        Draft,
        [JsonProperty("issued")]
    ...
    public static class GetSalesInvoiceStatusExtension
    {
        public static string Value(this GetSalesInvoiceStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static GetSalesInvoiceStatus ToEnum(this string value)
        {
            foreach(var field in typeof(GetSalesInvoiceStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is GetSalesInvoiceStatus)
                    {
                        return (GetSalesInvoiceStatus)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum GetSalesInvoiceStatus");
        }
    }
