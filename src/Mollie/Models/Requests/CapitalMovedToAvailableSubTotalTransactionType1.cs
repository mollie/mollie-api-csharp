...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CapitalMovedToAvailableSubTotalTransactionType1
    {
    ...
    public static class CapitalMovedToAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this CapitalMovedToAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CapitalMovedToAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CapitalMovedToAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CapitalMovedToAvailableSubTotalTransactionType1)
                    {
                        return (CapitalMovedToAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CapitalMovedToAvailableSubTotalTransactionType1");
        }
    }
