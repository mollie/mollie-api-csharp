...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TopupsPendingSubtotalTransactionType2
    {
    ...
    public static class TopupsPendingSubtotalTransactionType2Extension
    {
        public static string Value(this TopupsPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TopupsPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(TopupsPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TopupsPendingSubtotalTransactionType2)
                    {
                        return (TopupsPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TopupsPendingSubtotalTransactionType2");
        }
    }
