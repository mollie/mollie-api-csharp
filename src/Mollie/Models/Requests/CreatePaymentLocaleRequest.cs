...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreatePaymentLocaleRequest
    {
        [JsonProperty("en_US")]
        EnUS,
        [JsonProperty("en_GB")]
    ...
    public static class CreatePaymentLocaleRequestExtension
    {
        public static string Value(this CreatePaymentLocaleRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreatePaymentLocaleRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreatePaymentLocaleRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreatePaymentLocaleRequest)
                    {
                        return (CreatePaymentLocaleRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreatePaymentLocaleRequest");
        }
    }
