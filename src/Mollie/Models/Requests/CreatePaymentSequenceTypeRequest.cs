...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreatePaymentSequenceTypeRequest
    {
        [JsonProperty("oneoff")]
        Oneoff,
        [JsonProperty("first")]
    ...
    public static class CreatePaymentSequenceTypeRequestExtension
    {
        public static string Value(this CreatePaymentSequenceTypeRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreatePaymentSequenceTypeRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreatePaymentSequenceTypeRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreatePaymentSequenceTypeRequest)
                    {
                        return (CreatePaymentSequenceTypeRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreatePaymentSequenceTypeRequest");
        }
    }
