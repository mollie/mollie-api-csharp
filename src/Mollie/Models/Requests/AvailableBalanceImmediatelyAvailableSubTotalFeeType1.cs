...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum AvailableBalanceImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class AvailableBalanceImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this AvailableBalanceImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AvailableBalanceImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(AvailableBalanceImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AvailableBalanceImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (AvailableBalanceImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AvailableBalanceImmediatelyAvailableSubTotalFeeType1");
        }
    }
