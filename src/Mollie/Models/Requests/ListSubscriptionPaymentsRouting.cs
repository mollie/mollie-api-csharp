...
namespace Mollie.Models.Requests
{
    ...
    public class ListSubscriptionPaymentsRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public ListSubscriptionPaymentsRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public ListSubscriptionPaymentsRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public ListSubscriptionPaymentsDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public ListSubscriptionPaymentsRoutingLinks Links { get; set; } = default!;
    }
}