...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsMovedToAvailableSubTotalFeeType1
    {
    ...
    public static class CorrectionsMovedToAvailableSubTotalFeeType1Extension
    {
        public static string Value(this CorrectionsMovedToAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsMovedToAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsMovedToAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsMovedToAvailableSubTotalFeeType1)
                    {
                        return (CorrectionsMovedToAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsMovedToAvailableSubTotalFeeType1");
        }
    }
