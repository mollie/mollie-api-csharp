...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PendingBalanceMovedToAvailableSubTotalFeeType1
    {
    ...
    public static class PendingBalanceMovedToAvailableSubTotalFeeType1Extension
    {
        public static string Value(this PendingBalanceMovedToAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PendingBalanceMovedToAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PendingBalanceMovedToAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PendingBalanceMovedToAvailableSubTotalFeeType1)
                    {
                        return (PendingBalanceMovedToAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PendingBalanceMovedToAvailableSubTotalFeeType1");
        }
    }
