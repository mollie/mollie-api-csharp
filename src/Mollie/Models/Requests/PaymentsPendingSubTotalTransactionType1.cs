...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PaymentsPendingSubTotalTransactionType1
    {
    ...
    public static class PaymentsPendingSubTotalTransactionType1Extension
    {
        public static string Value(this PaymentsPendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PaymentsPendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PaymentsPendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PaymentsPendingSubTotalTransactionType1)
                    {
                        return (PaymentsPendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PaymentsPendingSubTotalTransactionType1");
        }
    }
