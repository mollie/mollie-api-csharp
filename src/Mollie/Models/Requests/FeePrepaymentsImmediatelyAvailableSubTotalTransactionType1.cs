...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1
    {
    ...
    public static class FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1)
                    {
                        return (FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsImmediatelyAvailableSubTotalTransactionType1");
        }
    }
