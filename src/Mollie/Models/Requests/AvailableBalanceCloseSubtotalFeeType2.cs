...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum AvailableBalanceCloseSubtotalFeeType2
    {
    ...
    public static class AvailableBalanceCloseSubtotalFeeType2Extension
    {
        public static string Value(this AvailableBalanceCloseSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AvailableBalanceCloseSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(AvailableBalanceCloseSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AvailableBalanceCloseSubtotalFeeType2)
                    {
                        return (AvailableBalanceCloseSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AvailableBalanceCloseSubtotalFeeType2");
        }
    }
