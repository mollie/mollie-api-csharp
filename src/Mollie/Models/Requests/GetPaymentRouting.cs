...
namespace Mollie.Models.Requests
{
    ...
    public class GetPaymentRouting
    {
        ...
        /// </summary>
        [JsonProperty("mode")]
        public GetPaymentRoutingMode Mode { get; set; } = default!;

        /// <summary>
        /// The portion of the total payment amount being routed. Currently only `EUR` payments can be routed.
        /// </summary>
        [JsonProperty("amount")]
        public GetPaymentRoutingAmount Amount { get; set; } = default!;

        /// <summary>
        /// The destination of this portion of the payment.
        /// </summary>
        [JsonProperty("destination")]
        public GetPaymentDestination Destination { get; set; } = default!;
        ...
        /// </summary>
        [JsonProperty("_links")]
        public GetPaymentRoutingLinks Links { get; set; } = default!;
    }
}