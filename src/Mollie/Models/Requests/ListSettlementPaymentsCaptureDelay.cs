...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListSettlementPaymentsCaptureDelay
    {
        [JsonProperty("... hours")]
        DotDotDotHours,
        [JsonProperty("... days")]
    ...
    public static class ListSettlementPaymentsCaptureDelayExtension
    {
        public static string Value(this ListSettlementPaymentsCaptureDelay value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListSettlementPaymentsCaptureDelay ToEnum(this string value)
        {
            foreach(var field in typeof(ListSettlementPaymentsCaptureDelay).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListSettlementPaymentsCaptureDelay)
                    {
                        return (ListSettlementPaymentsCaptureDelay)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListSettlementPaymentsCaptureDelay");
        }
    }
