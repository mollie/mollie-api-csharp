...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CapitalImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class CapitalImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this CapitalImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CapitalImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(CapitalImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CapitalImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (CapitalImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CapitalImmediatelyAvailableSubTotalFeeType1");
        }
    }
