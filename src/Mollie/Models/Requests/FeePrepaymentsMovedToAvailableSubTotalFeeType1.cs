...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsMovedToAvailableSubTotalFeeType1
    {
    ...
    public static class FeePrepaymentsMovedToAvailableSubTotalFeeType1Extension
    {
        public static string Value(this FeePrepaymentsMovedToAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsMovedToAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsMovedToAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsMovedToAvailableSubTotalFeeType1)
                    {
                        return (FeePrepaymentsMovedToAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsMovedToAvailableSubTotalFeeType1");
        }
    }
