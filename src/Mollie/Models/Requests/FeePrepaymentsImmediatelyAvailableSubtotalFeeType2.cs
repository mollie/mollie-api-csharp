...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum FeePrepaymentsImmediatelyAvailableSubtotalFeeType2
    {
    ...
    public static class FeePrepaymentsImmediatelyAvailableSubtotalFeeType2Extension
    {
        public static string Value(this FeePrepaymentsImmediatelyAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FeePrepaymentsImmediatelyAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(FeePrepaymentsImmediatelyAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is FeePrepaymentsImmediatelyAvailableSubtotalFeeType2)
                    {
                        return (FeePrepaymentsImmediatelyAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum FeePrepaymentsImmediatelyAvailableSubtotalFeeType2");
        }
    }
