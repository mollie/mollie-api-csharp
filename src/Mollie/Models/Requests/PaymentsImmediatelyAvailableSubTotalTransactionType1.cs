...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum PaymentsImmediatelyAvailableSubTotalTransactionType1
    {
    ...
    public static class PaymentsImmediatelyAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this PaymentsImmediatelyAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static PaymentsImmediatelyAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(PaymentsImmediatelyAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is PaymentsImmediatelyAvailableSubTotalTransactionType1)
                    {
                        return (PaymentsImmediatelyAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum PaymentsImmediatelyAvailableSubTotalTransactionType1");
        }
    }
