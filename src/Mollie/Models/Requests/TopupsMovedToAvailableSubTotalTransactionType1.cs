...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TopupsMovedToAvailableSubTotalTransactionType1
    {
    ...
    public static class TopupsMovedToAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this TopupsMovedToAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TopupsMovedToAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(TopupsMovedToAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TopupsMovedToAvailableSubTotalTransactionType1)
                    {
                        return (TopupsMovedToAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TopupsMovedToAvailableSubTotalTransactionType1");
        }
    }
