...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum CreateCustomerPaymentSequenceTypeRequest
    {
        [JsonProperty("oneoff")]
        Oneoff,
        [JsonProperty("first")]
    ...
    public static class CreateCustomerPaymentSequenceTypeRequestExtension
    {
        public static string Value(this CreateCustomerPaymentSequenceTypeRequest value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CreateCustomerPaymentSequenceTypeRequest ToEnum(this string value)
        {
            foreach(var field in typeof(CreateCustomerPaymentSequenceTypeRequest).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CreateCustomerPaymentSequenceTypeRequest)
                    {
                        return (CreateCustomerPaymentSequenceTypeRequest)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CreateCustomerPaymentSequenceTypeRequest");
        }
    }
