...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum CorrectionsImmediatelyAvailableSubtotalFeeType2
    {
    ...
    public static class CorrectionsImmediatelyAvailableSubtotalFeeType2Extension
    {
        public static string Value(this CorrectionsImmediatelyAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CorrectionsImmediatelyAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(CorrectionsImmediatelyAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CorrectionsImmediatelyAvailableSubtotalFeeType2)
                    {
                        return (CorrectionsImmediatelyAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CorrectionsImmediatelyAvailableSubtotalFeeType2");
        }
    }
