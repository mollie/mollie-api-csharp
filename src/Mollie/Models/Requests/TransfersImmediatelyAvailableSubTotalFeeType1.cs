...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TransfersImmediatelyAvailableSubTotalFeeType1
    {
    ...
    public static class TransfersImmediatelyAvailableSubTotalFeeType1Extension
    {
        public static string Value(this TransfersImmediatelyAvailableSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TransfersImmediatelyAvailableSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(TransfersImmediatelyAvailableSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransfersImmediatelyAvailableSubTotalFeeType1)
                    {
                        return (TransfersImmediatelyAvailableSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TransfersImmediatelyAvailableSubTotalFeeType1");
        }
    }
