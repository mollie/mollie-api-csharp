...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum MovedFromPendingSubtotalFeeType2
    {
    ...
    public static class MovedFromPendingSubtotalFeeType2Extension
    {
        public static string Value(this MovedFromPendingSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static MovedFromPendingSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(MovedFromPendingSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is MovedFromPendingSubtotalFeeType2)
                    {
                        return (MovedFromPendingSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum MovedFromPendingSubtotalFeeType2");
        }
    }
