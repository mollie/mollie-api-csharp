...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public class ListPaymentsPaymentLinks
    {
        ...
        /// </summary>
        [JsonProperty("self")]
        public ListPaymentsPaymentSelf Self { get; set; } = default!;

        /// <summary>
        /// The URL your customer should visit to make the payment. This is where you should redirect the customer to.
        /// </summary>
        [JsonProperty("checkout")]
        public ListPaymentsCheckout? Checkout { get; set; }

        /// <summary>
        /// The deeplink URL to the app of the payment method. Currently only available for `bancontact`.
        /// </summary>
        [JsonProperty("mobileAppCheckout")]
        public ListPaymentsMobileAppCheckout? MobileAppCheckout { get; set; }
        ...
        public ListPaymentsChangePaymentState? ChangePaymentState { get; set; }

        /// <summary>
        /// Direct link to the payment in the Mollie Dashboard.
        /// </summary>
        [JsonProperty("dashboard")]
        public ListPaymentsDashboard Dashboard { get; set; } = default!;

        /// <summary>
        /// The API resource URL of the <a href="list-payment-refunds">refunds</a> that belong to this payment.
        /// </summary>
        [JsonProperty("refunds")]
        public ListPaymentsRefunds? Refunds { get; set; }
        ...
        /// </summary>
        [JsonProperty("order")]
        public ListPaymentsOrder? Order { get; set; }
        ...
        public ListPaymentsTerminal? Terminal { get; set; }

        /// <summary>
        /// In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field.
        /// </summary>
        [JsonProperty("documentation")]
        public ListPaymentsPaymentDocumentation? Documentation { get; set; }
        ...
        /// </summary>
        [JsonProperty("status")]
        public ListPaymentsLinksStatus? Status { get; set; }
        ...
        public ListPaymentsPayOnline? PayOnline { get; set; }
    }
}