...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum TransfersPendingSubTotalFeeType1
    {
    ...
    public static class TransfersPendingSubTotalFeeType1Extension
    {
        public static string Value(this TransfersPendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TransfersPendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(TransfersPendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TransfersPendingSubTotalFeeType1)
                    {
                        return (TransfersPendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TransfersPendingSubTotalFeeType1");
        }
    }
