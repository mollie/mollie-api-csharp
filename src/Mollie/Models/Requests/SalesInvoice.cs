...
namespace Mollie.Models.Requests
{
    ...
    public class SalesInvoice
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public ListSalesInvoicesStatus? Status { get; set; }

        /// <summary>
        /// The VAT scheme to create the invoice for. You must be enrolled with One Stop Shop enabled to use it.
        /// </summary>
        [JsonProperty("vatScheme")]
        public ListSalesInvoicesVatScheme? VatScheme { get; set; } = Mollie.Models.Requests.ListSalesInvoicesVatScheme.Standard;
        ...
        public ListSalesInvoicesVatMode? VatMode { get; set; } = Mollie.Models.Requests.ListSalesInvoicesVatMode.Exclusive;
        ...
        public ListSalesInvoicesMetadata? Metadata { get; set; } = null;

        /// <summary>
        /// The payment term to be set on the invoice.
        /// </summary>
        [JsonProperty("paymentTerm")]
        public ListSalesInvoicesPaymentTerm? PaymentTerm { get; set; } = Mollie.Models.Requests.ListSalesInvoicesPaymentTerm.Thirtydays;
        ...
        public ListSalesInvoicesPaymentDetails? PaymentDetails { get; set; } = null;
        ...
        public ListSalesInvoicesEmailDetails? EmailDetails { get; set; } = null;
        ...
        public ListSalesInvoicesRecipient? Recipient { get; set; } = null;
        ...
        /// </summary>
        [JsonProperty("lines")]
        public List<ListSalesInvoicesLine>? Lines { get; set; } = null;

        /// <summary>
        /// The discount to be applied to the entire invoice, applied on top of any line item discounts.
        /// </summary>
        [JsonProperty("discount")]
        public ListSalesInvoicesDiscount? Discount { get; set; } = null;

        /// <summary>
        /// The amount that is left to be paid.
        /// </summary>
        [JsonProperty("amountDue")]
        public ListSalesInvoicesAmountDue? AmountDue { get; set; }

        /// <summary>
        /// The total amount without VAT before discounts.
        /// </summary>
        [JsonProperty("subtotalAmount")]
        public ListSalesInvoicesSubtotalAmount? SubtotalAmount { get; set; }

        /// <summary>
        /// The total amount with VAT.
        /// </summary>
        [JsonProperty("totalAmount")]
        public ListSalesInvoicesTotalAmount? TotalAmount { get; set; }

        /// <summary>
        /// The total VAT amount.
        /// </summary>
        [JsonProperty("totalVatAmount")]
        public ListSalesInvoicesTotalVatAmount? TotalVatAmount { get; set; }

        /// <summary>
        /// The total amount without VAT after discounts.
        /// </summary>
        [JsonProperty("discountedSubtotalAmount")]
        public ListSalesInvoicesDiscountedSubtotalAmount? DiscountedSubtotalAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("_links")]
        public SalesInvoiceLinks? Links { get; set; }
    }
}