...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum AvailableBalanceCloseSubtotalTransactionType2
    {
    ...
    public static class AvailableBalanceCloseSubtotalTransactionType2Extension
    {
        public static string Value(this AvailableBalanceCloseSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AvailableBalanceCloseSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(AvailableBalanceCloseSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AvailableBalanceCloseSubtotalTransactionType2)
                    {
                        return (AvailableBalanceCloseSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AvailableBalanceCloseSubtotalTransactionType2");
        }
    }
