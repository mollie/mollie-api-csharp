...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum OpenAvailableSubtotalFeeType2
    {
    ...
    public static class OpenAvailableSubtotalFeeType2Extension
    {
        public static string Value(this OpenAvailableSubtotalFeeType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static OpenAvailableSubtotalFeeType2 ToEnum(this string value)
        {
            foreach(var field in typeof(OpenAvailableSubtotalFeeType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is OpenAvailableSubtotalFeeType2)
                    {
                        return (OpenAvailableSubtotalFeeType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum OpenAvailableSubtotalFeeType2");
        }
    }
