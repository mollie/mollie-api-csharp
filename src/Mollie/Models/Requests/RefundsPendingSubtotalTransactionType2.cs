...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsPendingSubtotalTransactionType2
    {
    ...
    public static class RefundsPendingSubtotalTransactionType2Extension
    {
        public static string Value(this RefundsPendingSubtotalTransactionType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsPendingSubtotalTransactionType2 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsPendingSubtotalTransactionType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsPendingSubtotalTransactionType2)
                    {
                        return (RefundsPendingSubtotalTransactionType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsPendingSubtotalTransactionType2");
        }
    }
