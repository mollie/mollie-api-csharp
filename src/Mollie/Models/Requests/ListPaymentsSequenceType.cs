...
namespace Mollie.Models.Requests
{
    ...
    /// </remarks>
    /// </summary>
    public enum ListPaymentsSequenceType
    {
        [JsonProperty("oneoff")]
        Oneoff,
        [JsonProperty("first")]
    ...
    public static class ListPaymentsSequenceTypeExtension
    {
        public static string Value(this ListPaymentsSequenceType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListPaymentsSequenceType ToEnum(this string value)
        {
            foreach(var field in typeof(ListPaymentsSequenceType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListPaymentsSequenceType)
                    {
                        return (ListPaymentsSequenceType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListPaymentsSequenceType");
        }
    }
