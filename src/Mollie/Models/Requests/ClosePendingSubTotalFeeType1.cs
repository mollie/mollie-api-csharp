...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ClosePendingSubTotalFeeType1
    {
    ...
    public static class ClosePendingSubTotalFeeType1Extension
    {
        public static string Value(this ClosePendingSubTotalFeeType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ClosePendingSubTotalFeeType1 ToEnum(this string value)
        {
            foreach(var field in typeof(ClosePendingSubTotalFeeType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ClosePendingSubTotalFeeType1)
                    {
                        return (ClosePendingSubTotalFeeType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ClosePendingSubTotalFeeType1");
        }
    }
