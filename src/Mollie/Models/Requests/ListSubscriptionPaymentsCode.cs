...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ListSubscriptionPaymentsCode
    {
    ...
    public static class ListSubscriptionPaymentsCodeExtension
    {
        public static string Value(this ListSubscriptionPaymentsCode value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListSubscriptionPaymentsCode ToEnum(this string value)
        {
            foreach(var field in typeof(ListSubscriptionPaymentsCode).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListSubscriptionPaymentsCode)
                    {
                        return (ListSubscriptionPaymentsCode)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ListSubscriptionPaymentsCode");
        }
    }
