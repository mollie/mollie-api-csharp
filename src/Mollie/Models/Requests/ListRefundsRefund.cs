...
namespace Mollie.Models.Requests
{
    ...
    public class ListRefundsRefund
    {
        ...
        public ListRefundsMetadata? Metadata { get; set; } = null;
        ...
        public ListRefundsExternalReference? ExternalReference { get; set; }
        ...
        public List<ListRefundsRoutingReversal>? RoutingReversals { get; set; } = null;

        /// <summary>
        /// An object with several relevant URLs. Every URL object will contain an `href` and a `type` field.
        /// </summary>
        [JsonProperty("_links")]
        public ListRefundsRefundLinks? Links { get; set; }
    }
}