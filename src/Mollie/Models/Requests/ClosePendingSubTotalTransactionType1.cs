...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum ClosePendingSubTotalTransactionType1
    {
    ...
    public static class ClosePendingSubTotalTransactionType1Extension
    {
        public static string Value(this ClosePendingSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ClosePendingSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(ClosePendingSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ClosePendingSubTotalTransactionType1)
                    {
                        return (ClosePendingSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ClosePendingSubTotalTransactionType1");
        }
    }
