...
namespace Mollie.Models.Requests
{
    ...
    /// </summary>
    public enum RefundsMovedToAvailableSubTotalTransactionType1
    {
    ...
    public static class RefundsMovedToAvailableSubTotalTransactionType1Extension
    {
        public static string Value(this RefundsMovedToAvailableSubTotalTransactionType1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static RefundsMovedToAvailableSubTotalTransactionType1 ToEnum(this string value)
        {
            foreach(var field in typeof(RefundsMovedToAvailableSubTotalTransactionType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is RefundsMovedToAvailableSubTotalTransactionType1)
                    {
                        return (RefundsMovedToAvailableSubTotalTransactionType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum RefundsMovedToAvailableSubTotalTransactionType1");
        }
    }
