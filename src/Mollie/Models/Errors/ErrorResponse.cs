...
namespace Mollie.Models.Errors
{
    ...
    public class ErrorResponsePayload
    {
        ...
        [JsonProperty("_links")]
        public ErrorResponseLinks Links { get; set; } = default!;
    ...
    public class ErrorResponse : BaseException
    {
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible. Use ErrorResponse.Payload.Field instead.")]
        public string? Field { get; set; }

        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible. Use ErrorResponse.Payload.Links instead.")]
        public ErrorResponseLinks Links { get; set; } = default!;
