...
namespace Mollie
{
    ...
    public interface IBalanceTransfers
    {
        ...
        /// <exception cref="ErrorResponse">The request contains issues. For example, if the amount is missing. Thrown when the API returns a 422 or 429 response.</exception>
