...
namespace Mollie
{
    ...
    public class BalanceTransfers: IBalanceTransfers
    {
        ...
        public async Task<CreateConnectBalanceTransferResponse> CreateAsync(string? idempotencyKey = null, EntityBalanceTransfer? entityBalanceTransfer = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "create-connect-balance-transfer", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<ListConnectBalanceTransfersResponse> ListAsync(ListConnectBalanceTransfersRequest? request = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "list-connect-balance-transfers", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
        ...
        public async Task<GetConnectBalanceTransferResponse> GetAsync(string id, bool? testmode = null, string? idempotencyKey = null, RetryConfig? retryConfig = null, CancellationToken? cancellationToken = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "get-connect-balance-transfer", new List<string> {  }, SDKConfiguration.SecuritySource, cancellationToken);
