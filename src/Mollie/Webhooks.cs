...
namespace Mollie
{
    ...
    public interface IWebhooks
    {
        ...
        /// <exception cref="ErrorResponse">The request contains issues. For example, if the URL is missing. Thrown when the API returns a 422 or 429 response.</exception>
    ...
    public class Webhooks: IWebhooks
    {
        ...
        )
        {
            ...
            Func<Task<ListWebhooksResponse?>> nextFunc = async delegate()
            {
                ...
                var newRequest = new ListWebhooksRequest
                {
                    From = request?.From,
                    Limit = request?.Limit,
                    Sort = request?.Sort,
